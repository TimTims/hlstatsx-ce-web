...
*/
	...
	if ($numitems > 0) { ?>
		<div class="col-md-12 mt-2">
          <div class="card">
            <div class="card-body">
              <p class="text-uppercase text-sm">Weapon Selection</p>
              <div class="row">
				<div class="col-md-12">
					<?php $tblWeapons->draw($result, $numitems, 95); ?>
				</div>
              </div>
            </div>
          </div>
...
<?php
	...
	if ($numitems > 0) { ?>
		<div class="col-md-12 mt-2">
          <div class="card">
            <div class="card-body">
              <p class="text-uppercase text-sm">Weapon Statistics</p>
              <div class="row">
				<div class="col-md-12">
					<?php $tblWeaponstats->draw($result, $numitems, 95); ?>
				</div>
              </div>
            </div>
          </div>
...
<?php
	...
	{ ?>
		<div class="col-md-12 mt-2">
          <div class="card">
            <div class="card-body">
              <p class="text-uppercase text-sm">Weapon Target</p>
              <div class="row">
				<div class="col-md-12">
					<?php $tblWeaponstats2->draw($result, $db->num_rows($result), 95); ?>
				</div>
              </div>
            </div>
          </div>
