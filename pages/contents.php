            ...
            <div class="card mb-4">
				...
				<table class="table">
					<tr>
						...
						<td class="text-center">&nbsp;Top Player</td>
						<td class="text-center">&nbsp;Top Clan</td>
					</tr>
					<?php
						$nonhiddengamestring = "(";
				...
				<tr>
					<td>
						<div style="float:left;line-height:30px;" class="align-middle">&nbsp;<a href="<?php echo $g_options['scripturl'] . "?game=$gamedata[0]"; ?>"><img src="<?php
